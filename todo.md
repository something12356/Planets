...
- [ ] Optimisation for gravity to skip planets already been checked, so the for loop should be size n, size n-1 etc down to size 0, should apply the opposite force each time gravity is calculated to a planet.
